        ...
        <table class="text-left w-full border-collapse">
          ...
          <tbody>
            ...
            <tr class="hover:bg-grey-lighter">
              ...
              <td class="py-5 px-6 border-b border-grey-light" style="display: flex; justify-content:space-evenly;">
