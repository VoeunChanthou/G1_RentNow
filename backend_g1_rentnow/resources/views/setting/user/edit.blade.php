              ...
              <div class="bg-white shadow-md rounded my-6 p-5">
                <form method="POST" action="{{ route('admin.users.update',$user->id)}}">
                  ...
                  <div class="flex flex-col space-y-2">
                    ...
                    <input id="name" type="text" name="name" value="{{ old('first_name', $user->first_name) }}"
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <input id="email" type="email" name="password" value="{{ old('email', $user->email) }}"
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <input id="phone_number" type="number" name="phone_number"  value="{{ old('phone_number', $user->phone_number) }}" placeholder="phone number" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200"
                    />
                </div>
