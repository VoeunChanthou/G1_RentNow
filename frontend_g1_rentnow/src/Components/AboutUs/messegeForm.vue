<template>
  <div class="container mt-5" style="border-radius: 1px; background-color: #ffff; z-index: 3;">
    <div class="d-flex flex-column" style="width: 100%">
      <form @submit.prevent="submitComment" class="d-flex justify-content-spece-between">
        ...
        <div class="row mt-5" style="margin-right: 25px;">
          ...
          <div class="" style="width: 100; display: flex; justify-content: space-between;">
            <div class="mt-3" style="width: 45%;">
              ...
              <input type="text" placeholder="First name" id="defaultFirstName" v-model="users.first_name" class="form-control" />
            </div>
            <div class="mt-3" style="width: 45%;">
              <label htmlFor="defaultLastname" class="text-muted"> Last Name </label>
              <input type="text" placeholder="last name" id="defaultLastname" v-model="users.last_name" class="form-control" />
            </div>
          </div>
          <div class="mt-3">
            <label htmlFor="email" class="text-muted"> Email </label>
            <input type="email" placeholder="Email" id="email" class="form-control" v-model="users.email" />
          </div>
          <div class="mt-3">
