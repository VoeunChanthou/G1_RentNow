  ...
  <div class="content" style="width: 100%">
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
          ...
          >
            <a
              ...
              href="/"
              style="background: #691ba5; font-weight: bold"
              >Login</a
            >
            <a
              type="button"
              class="btn btn-lg text-white"
              data-bs-toggle="modal"
              data-bs-target="#popupRegister"
              href="/register"
              style="background: #ffd800; font-weight: bold"
              >Register</a
            >
          </div>
          ...
          <div class="dropdown ms-1 ms-lg-0" v-if="AuthUSer.user">
            <a
              class="avatar avatar-sm p-0 d-flex align-items-center"
              href="#"
              id="profileDropdown"
              role="button"
            ...
            >
              ...
              <li class="px-3">
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <a class="h6" href="#"
                      >{{ AuthUSer.user.first_name }} {{ AuthUSer.user.last_name }}</a
                    >
              ...
              <li>
                <a class="dropdown-item" href="/history"
                  ><i class="bi bi-person fa-fw me-2"></i>My borrow</a
                >
              </li>
              <li>
                <a class="dropdown-item" href="#"
              ...
              <li>
                <button class="dropdown-item" @click="onSubmit">
    ...
    >
      <div class="container-fluid px-5 py-2">
        <ul
          class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll"
          style="width: 30%; display: flex; justify-content: space-between; align-items: center"
        >
          <li class="nav-item"><a href="/">Home</a></li>
          <li class="nav-item"><a href="/service">Service</a></li>
          <li class="nav-item"><a href="/aboutUs">About Us</a></li>
        </ul>
        <li v-if="AuthUSer.user" class="nav-item" style="list-style-type: none; margin-right: 10px">
          <a href="#"
            ><Icon icon="ri:heart-fill" width="40" height="40" style="color: #940065"
          /></a>
        </li>
        <li v-if="AuthUSer.user" class="nav-item" style="list-style-type: none">
          <a href="/message"
            ><Icon icon="wpf:message-outline" width="52" height="40" style="color: #940065"
          /></a>
        </li>
      </div>
    </nav>
